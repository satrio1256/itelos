...
public class PresensiMahasiswa extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_presensi_mahasiswa);
...
//        toggle.syncState();
        ...
        navigationView.getMenu().findItem(R.id.presensi_mahasiswa).setChecked(true);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.presensi_mahasiswa, menu);
        return true;
    }
